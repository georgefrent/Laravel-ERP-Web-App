...
class TicketsScreen extends Screen
{
    /**
    ...
    public function layout(): iterable
    {
        ...
        // $user_name = User::all()->pluck('name', 'user_id');
        $userData = User::where('id', $ticket->user_id)->first();
            ...
            Layout::table('table', [
                TD::make('view', '')
                    ...
                    ->render(fn (Repository $model) =>
                        '<a href="' . route('platform.ticket.view', $model->get('id')) . '" class="btn btn-default center-text">View</a>'
                    ),
