...
class ClientOrdersScreen extends Screen
{
    /**
            ...
            Layout::table('table', [
                TD::make('view', '')
                    ...
                    ->render(fn (Repository $model) =>
                        '<a href="' . route('platform.order.view', $model->get('id')) . '" class="btn btn-default center-text">View</a>'
                    ),
                TD::make('id', 'ID')
                    ->width('50')
                ...
                TD::make('device_name', 'Numele dispozitivului')
                    ->width('150')
